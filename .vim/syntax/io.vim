...
syntax keyword ioType LinkList List Lobby Locals Logging MD5 MP3Decoder
syntax keyword ioType MP3Encoder Map
syntax keyword ioType Message Movie Notification Number Object
syntax keyword ioType OpenGL Point Protos Regex SGML SGMLElement SGMLParser
syntax keyword ioType SQLite Server Sequence
...
syntax keyword ioType UPDReceiver URL User Warning WeakLink Web
